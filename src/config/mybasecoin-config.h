/* src/config/mybasecoin-config.h.  Generated from mybasecoin-config.h.in by configure.  */
/* src/config/mybasecoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SYNDICATE_CONFIG_H

#define SYNDICATE_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Mybasecoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Mybasecoin Core"
...
#define PACKAGE_BUGREPORT "http://www.syndicate.com/"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Mybasecoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Mybasecoin Core 1.9.9"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mybasecoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "http://www.syndicate.com/"
